...
const docTemplate = `{
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/object.GeneratePresignedURLInput"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/object.GeneratePresignedURLResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "object.GeneratePresignedURLInput": {
            "type": "object",
            "properties": {
                "bucket_key": {
                    "type": "string"
        ...
        "object.GeneratePresignedURLResponse": {
            "type": "object",
            "properties": {
                "url": {
                    "type": "string"
